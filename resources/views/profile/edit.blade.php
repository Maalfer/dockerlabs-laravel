...
@section('content')
    ...
    <style>
        ...
        .quick-link--bunker { border-color: rgba(220, 38, 38, 0.3); }
        .quick-link--bunker:hover { border-color: #ef4444; }
        .quick-link--mod { border-color: rgba(245, 158, 11, 0.3); }
        .quick-link--mod:hover { border-color: #f59e0b; }
        .quick-link--admin { border-color: rgba(139, 92, 246, 0.3); }
        .quick-link--admin:hover { border-color: #8b5cf6; }
        .token-alert {
            margin: 1.5rem 0;
            padding: 1.5rem;
        ...
        .token-alert__header { font-weight: 700; margin-bottom: 0.5rem; }
        .token-alert__code {
            display: block;
            padding: 0.75rem;
        ...
        .token-alert__note { opacity: 0.9; font-size: 0.9rem; }
        ...
        @media (max-width: 768px) {
            .token-form__grid { grid-template-columns: 1fr; }
        }
        .token-input, .token-date {
            padding: 0.75rem;
        ...
        .tokens-table td { padding: 1rem; border-bottom: 1px solid var(--border); color: var(--text); }
        .tokens-table tr:last-child td { border-bottom: none; }
        .tokens-table tr:hover { background: rgba(138, 180, 248, 0.05); }
        .status-badge { padding: 0.25rem 0.75rem; border-radius: 999px; font-size: 0.8rem; font-weight: 700; }
        .status-badge--active { background: rgba(34, 197, 94, 0.2); color: #4ade80; border: 1px solid rgba(34, 197, 94, 0.3); }
        .status-badge--inactive { background: rgba(148, 163, 184, 0.2); color: #94a3b8; border: 1px solid rgba(148, 163, 184, 0.3); }
        .token-actions { display: flex; gap: 0.5rem; flex-wrap: wrap; }
        .btn-sm { padding: 0.5rem 0.75rem; font-size: 0.85rem; }
        .empty-state { text-align: center; color: var(--muted); font-style: italic; padding: 2rem !important; }
        .profile-form {
            max-width: 600px;
            background: linear-gradient(135deg, var(--surface), var(--surface-2));
            padding: 2rem;
        ...
        .form-label { display: block; margin-bottom: 0.5rem; font-weight: 600; color: var(--brand-200); }
        .form-input {
            width: 100%;
        ...
        .form-input:focus { outline: none; border-color: var(--brand-300); box-shadow: 0 0 0 3px rgba(138, 180, 248, 0.15); }
        .form-divider { height: 1px; background: var(--border); margin: 2rem 0; }
        .password-title { font-weight: 700; margin-bottom: 1rem; color: var(--text); font-size: 1.1rem; }
        .btn-full { width: 100%; padding: 0.875rem 1.5rem; font-size: 1rem; }
